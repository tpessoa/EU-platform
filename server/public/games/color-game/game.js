...
var DB_src_original =
  "/api/games/color-game/assets/images/coloring-image-2.png";
var DB_src_painting =
  "/api/games/color-game/assets/images/coloring-image-2-2.png";
...
class playGame extends Phaser.Scene {
  ...
  async preload() {
    this.load.svg(
      "redo",
      "/api/games/color-game/assets/images/redo-solid.svg",
      { width: 50, height: 50 }
    );
    this.load.svg(
      "close",
      "/api/games/color-game/assets/images/times-circle-regular.svg",
      { width: 50, height: 50 }
    );
    this.load.svg(
      "carret",
      "/api/games/color-game/assets/images/caret-left-solid.svg",
      { width: 150, height: 150 }
    );
    this.load.svg(
      "circleImg",
      "/api/games/color-game/assets/images/circle-solid.svg",
      { scale: 0.15 }
    );
    ...
    this.load.audio(
      "btnclick",
      "/api/games/color-game/assets/sounds/btn_click_1.mp3"
    );
    this.load.audio(
      "painting1stroke",
      "/api/games/color-game/assets/sounds/painting_1_stroke.mp3"
    );
    this.load.audio(
      "rotation",
      "/api/games/color-game/assets/sounds/rotation.mp3"
    );
  ...
  loadFromDB(response) {
    ...
    if (response.data.game) {
      ...
      DB_image_ref = response.data.game.ref;
    }
  ...
  createCostum() {
    ...
    for (let circle_pos = 0; circle_pos < numColors; circle_pos++) {
      this.createCircle(
        circle_pos,
        color_bar_y,
        DB_all_colors[DB_game_colors[circle_pos]]
      );
    }
